...
$sql = $conn->query("INSERT INTO user(`username`, `password`, `name`,`emailid`) VALUES('$username','$password','$name','$email')");
echo '<script type="text/javascript">alert("New Admin Added successfully")</script>';
// $sql = "select * from user where id= '".$_SESSION['ad_uid']."' and password='".md5($oldpassword )."'";
// $q = $conn->query($sql);
// if($q->num_rows>0)
// {

// $sql = "update user set  password = '".md5($newpassword)."' WHERE id = '".$_SESSION['ad_uid']."'";
// $r = $conn->query($sql);
...
?>
               ...
               <div class="panel panel-success">
						...
						<form action="addadmin.php" method="post" id="signupForm1" class="form-horizontal">
						...
						<div class="form-group">
								<label class="col-sm-4 control-label" for="Old">Username</label>
								<div class="col-sm-5">
						...
						<div class="form-group">
								<div class="col-sm-9 col-sm-offset-4">
									<button type="submit" name="add" class="btn btn-success" style="border-radius:0%">ADD </button>
								</div>
							</div>
