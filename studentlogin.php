<?php
    ...
    $sql = "select * from student where emailid='".$username."'";

    $q = $conn->query($sql);
    if($q->num_rows==1)
    {
    $res = $q->fetch_assoc();
    $_SESSION['username']=$res['emailid'];
    $_SESSION['uid']=$res['id'];
                ...
                <div class="col-md-4 col-md-offset-4 col-sm-6 col-sm-offset-3 col-xs-10 col-xs-offset-1">
                            ...
                            <div class="panel-body" style="background-color: #E2E2E2; margin-top:70px; box-shadow: 5px 10px #888888;">
							  <h3 class="myhead">School Fees Management System</h3>
                                <form role="form" action="studentlogin.php" method="post">
                                    <hr />
                                    <h5 class="text-success">Use your email as username and password</h5>
									<?php
									if($error!='')
									{									
