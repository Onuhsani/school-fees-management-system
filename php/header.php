                ...
                <ul class="nav" id="main-menu">
                    <li>
                        <div class="user-img-div text-center">
                            ...
                            <h5 style="color:white;"><?php echo $_SESSION['ad_name'];?></h5>
                        </div>
                    ...
                    <li>
                        <a class="<?php if($page=='grade'){ echo 'active-menu';}?>" href="grade.php"><i class="fa fa-th-large"></i>Semesters</a>
                    </li>
                    <li>
                        <a class="<?php if($page=='course'){ echo 'active-menu';}?>" href="course.php"><i class="fa fa-th-large"></i>Courses</a>
                    </li>
